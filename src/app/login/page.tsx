      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-100 p-8">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <Link href="/forgot-password" className="text-sm text-primary-600 hover:underline">{t("login.forgot")}</Link>
          </div>
          ...
          <a
            ...
            className="w-full mt-4 flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition"
          >
        ...
        <p className="text-center mt-6 text-sm text-gray-600">
          {t("login.noAccount")}{" "}
          <Link href="/register" className="text-primary-600 hover:underline font-medium">{t("nav.signup")}</Link>
        </p>
      </div>
    </div>
  )

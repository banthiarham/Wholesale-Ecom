...
export class SettingsService {
  ...
  private getDefaultsWithMeta() {
    return [
      ...
      { key: 'primaryColor', value: '#0369a1', label: 'Primary Color', type: 'color', group: 'colors' },
      { key: 'secondaryColor', value: '#0f172a', label: 'Secondary Color', type: 'color', group: 'colors' },
      { key: 'accentColor', value: '#f59e0b', label: 'Accent Color', type: 'color', group: 'colors' },
      { key: 'headingFont', value: 'Poppins', label: 'Heading Font', type: 'text', group: 'typography' },
      { key: 'bodyFont', value: 'Open Sans', label: 'Body Font', type: 'text', group: 'typography' },
